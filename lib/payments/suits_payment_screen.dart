...
class SuitsPaymentScreen extends StatefulWidget {
  final double totalCartValue;
  final int totalItemCount;
  const SuitsPaymentScreen({
    super.key,
  ...
  @override
  State<SuitsPaymentScreen> createState() => _SuitsPaymentScreenState();
}

class _SuitsPaymentScreenState extends State<SuitsPaymentScreen> {
            ...
            try {
              ...
              await merchantEvcPlus.makePayment(
                ...
                onSuccess: (TransactionInfo successTransactionInfo) {
                  ...
                  value.checkoutSuits(context, "$Fieldname", '$email');
