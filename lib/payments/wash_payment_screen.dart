...
class WashPaymentScreen extends StatefulWidget {
  final double totalCartValue;
  final int TotalItemCount;
  const WashPaymentScreen({
    super.key,
  ...
  @override
  State<WashPaymentScreen> createState() => _WashPaymentScreenState();
}

class _WashPaymentScreenState extends State<WashPaymentScreen> {
            ...
            try {
              ...
              await merchantEvcPlus.makePayment(
                ...
                onSuccess: (TransactionInfo successTransactionInfo) {
                  ...
                  value.checkwashOrder(context, "$Fieldname", '$email');
