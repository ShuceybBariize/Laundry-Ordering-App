...
class WashandIronPaymentScreen extends StatefulWidget {
  final double totalCartValue;
  final int TotalItemCount;
  const WashandIronPaymentScreen({
    super.key,
  ...
  @override
  State<WashandIronPaymentScreen> createState() =>
      _WashandIronPaymentScreenState();
}

class _WashandIronPaymentScreenState extends State<WashandIronPaymentScreen> {
            ...
            try {
              ...
              await merchantEvcPlus.makePayment(
                ...
                onSuccess: (TransactionInfo successTransactionInfo) {
                  ...
                  value.checkoutwashIron(context, "$Fieldname", '$email');
