...
class UserStaffScreen extends StatefulWidget {
  const UserStaffScreen({super.key});

  @override
  State<UserStaffScreen> createState() => _UserStaffScreenState();
}

class _UserStaffScreenState extends State<UserStaffScreen> {
                  ...
                  if (_searchController.text.isEmpty) {
                    return UserCardView(
                        ...
                        onPressed: () {
                          editField();
                          setState(() {});
                          getdocid(items[index]['name'].toString());
                        });
                  }
