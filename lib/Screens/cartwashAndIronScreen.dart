...
import '../exports.dart';
import '../payments/wash_iron_payment_screen.dart';
import '../utility/cart_item.dart';

// ignore: must_be_immutable
class CartWashAndIronScreen extends StatelessWidget {
  static const String id = 'CartWashAndIronScreen';
  // showing field
  FirebaseFirestore firestore = FirebaseFirestore.instance;

  CartWashAndIronScreen({super.key});
                        ...
                        onTap: () {
                          if (value.items.isNotEmpty) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => WashandIronPaymentScreen(
