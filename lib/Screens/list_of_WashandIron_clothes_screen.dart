...
import 'cartwashAndIronScreen.dart';

class WashAndIronClothesList extends StatelessWidget {
  const WashAndIronClothesList({super.key});
            ...
            actions: [
              IconButton(
                onPressed: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => CartWashAndIronScreen())),
